...
for run in range(number_runs):
    ...
    for label in range(labels.shape[-1]):
        ...
        for_train = current_samples.shape[0]/10
    ...
    torch.save(datasets,"disc_FMNIST_unbalanced2/datasets_" + str(run) + ".pt")
    ...
    torch.save(model_disc,"disc_FMNIST_unbalanced2/model_disc_" +str(run) + ".pt")
